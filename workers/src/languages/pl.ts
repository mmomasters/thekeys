...
- Kod budynku głównego "Jana z Kolna 19" to 1 + 🔑 + 5687
- Kod do recepcji to 3256 + ENTER
- Kod apartamentu {apartment_name} to {full_pin} + 🟦

Twój kod apartamentu będzie działał TYLKO pomiędzy datą i godziną zameldowania i wymeldowania.
Twoje zameldowanie: {arrival} od 15.00
Twoje wymeldowanie: {departure} do 12.00

🅿️ PARKING : Dużo miejsc parkingowych znajduje się przy ulicy pod Kolna Apartments. Parking jest bezpłatny od 17:00 do 8:00 oraz w weekendy i święta, cennik: https://spp.szczecin.pl/informacja/cennik-strefy-platnego-parkowania
