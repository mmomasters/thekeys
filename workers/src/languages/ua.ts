...
- Код головної будівлі "Jana z Kolna 19" - 1 + 🔑 + 5687
- Код дверей у холл - 3256 + ENTER
- Код дверей апартаментів {apartment_name} - {full_pin} + 🟦
...
🅿️ Багато паркувальних місць розташовано на вулиці біля Kolna Apartments. Парковка безкоштовна з 17:00 до 08:00, а також у вихідні та святкові дні, ціни: https://spp.szczecin.pl/informacja/paid-parking-zone-pricing
