...
- Main building "Jana z Kolna 19" code is 1 + 🔑 + 5687
- Lobby door code is 3256 + ENTER
- Apartment {apartment_name} door code is {full_pin} + 🟦

Your apartment code will ONLY work between the check in and check out date and time.
Your check in: {arrival} from 15.00
Your check out: {departure} until 12.00

🅿️ PARKING : A lot of parking spaces are located on the street near Kolna Apartments. Parking is free from 5pm to 8am and during weekends and holidays, pricing: https://spp.szczecin.pl/informacja/paid-parking-zone-pricing
